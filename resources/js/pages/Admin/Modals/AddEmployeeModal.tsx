...
export default function AddEmployeeModal({ isOpen, onClose, departmentId, availableEmployees }: Props) {
  ...
  function onSubmit(e: React.FormEvent) {
    ...
    router.post(
      route('admin.departments.employees.add', departmentId),
      {
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="bg-white dark:bg-gray-800 shadow-xl border border-gray-200 dark:border-gray-700">
        <DialogHeader className="border-b border-gray-200 dark:border-gray-700 pb-4">
          <DialogTitle className="text-lg font-semibold text-gray-900 dark:text-white">Add Employee to Department</DialogTitle>
        </DialogHeader>
